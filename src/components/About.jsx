...
function About() {
  ...
  return (
    <section id="about" className="px-4 py-20 text-white bg-black md:px-6 md:py-24">
      <div className="grid items-center max-w-6xl gap-12 mx-auto md:grid-cols-2">
        <div className="flex justify-center md:justify-start">
          <div className="overflow-hidden rounded-3xl bg-[#111111] shadow-2xl">
            <img
              ...
              alt="About Wathsala"
              className="h-[320px] w-[260px] object-cover md:h-[480px] md:w-[360px]"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-6 mb-8 text-base font-medium md:gap-8 md:text-lg">
            <button
            ...
            {activeTab === "experience" && (
              <>
                ...
                <div>
                  ...
                  <p>
                    Finance Team Member – DataDive 2025 (Power BI Workshop &
                    Competition) <br />
                    <span className="text-sm text-gray-400">
            ...
            {activeTab === "education" && (
              <>
                ...
                <div>
                  ...
                  <p>
                    Full Stack Development, UI/UX Design (Strong Interest),
