              ...
              <div className="rounded-[32px] border border-white/10 bg-[#0b0b0f] p-6 shadow-[0_0_40px_rgba(34,197,94,0.08)]">
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="rounded-lg border border-white/15 px-4 py-2 text-sm font-medium text-white transition hover:border-green-400 hover:text-green-400"
                  >
                    GitHub
                  </a>
                  ...
                  {project.live && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="rounded-lg bg-green-500 px-4 py-2 text-sm font-medium text-black transition hover:bg-green-400"
                    >
                      Live Demo
                    </a>
                  )}
